...
Partial Class Teacher_Supervisor_PaymentsList
    Inherits Page
...
#Region "Fill Grid"
    ...
    Sub FillGrid(sender As Object, e As EventArgs)
        Try
            Dim dtTable As DataTable = DBContext.Getdatatable("select * from vw_Transactions where ForType in ('T', 'V') and " & CollectConditions() & "")
