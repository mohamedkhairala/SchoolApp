<%@ Page Title="Up Skills | All Students Payments" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Students_PaymentsList.aspx.vb" Inherits="Students_PaymentsList" %>
    ...
    <asp:UpdatePanel ID="UP" runat="server" ClientIDMode="Static" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="breadcrumbs-area">
                <h3>All Students Payments</h3>
                <ul>
                    <li>
                        <a href="../Dashboard.aspx">Home</a>
                    </li>
                    <li>All Students Payments</li>
                </ul>
            </div>
                ...
                <div class="card-body">
                    <div class="heading-layout1">
                        <div class="item-title">
                            <h3>All Students Payments Data</h3>
                        </div>
                        <!--<div class="dropdown">
                    ...
                    <div class="col-md-12 px-0 text-right">
                        <div class="d-inline-flex mb-3">
                            <%--<a href="Students_Payments.aspx" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark text-white fw-btn-fill">Add<i class="fa fa-plus ml-3"></i></a>--%>
                            <asp:LinkButton ID="lbAdd" runat="server" href="Students_Payments.aspx" CssClass="btn-fill-lg btn-gradient-yellow btn-hover-bluedark text-white fw-btn-fill">Add<i class="fa fa-plus ml-3"></i></asp:LinkButton>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:ListView ID="lvMaster" runat="server" ClientIDMode="AutoID">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <a href='<%# "Students_Payments.aspx?Mode=View&ID=" & Eval("ID")%>'><%# Eval("Code") %></a>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <asp:Panel ID="pnlView" runat="server">
                                                    <asp:LinkButton ID="lbView" runat="server" CssClass="dropdown-item" href='<%# "Students_Payments.aspx?Mode=View&ID=" & Eval("Id")%>'>
                                              <i class="fas fa-eye text-dodger-blue"></i>View
                                                    </asp:LinkButton>
                                                </asp:Panel>
                                                <asp:Panel ID="pnlEdit" runat="server">
                                                    <asp:LinkButton ID="lbEdit" runat="server" CssClass="dropdown-item" href='<%# "Students_Payments.aspx?Mode=Edit&ID=" & Eval("ID")%>'>
                                              <i class="fas fa-cogs text-dark-pastel-green"></i>Edit
                                                    </asp:LinkButton>
                                                </asp:Panel>
