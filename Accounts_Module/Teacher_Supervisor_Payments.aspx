<%@ Page Title="Up Skills | Add Teacher / Supervisor Payment" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Teacher_Supervisor_Payments.aspx.vb" Inherits="Teacher_Supervisor_Payments" %>
                ...
                <div class="card height-auto pb-4 ui-modal-box">
                    <div class="card-body py-4 modal-box">
                        <div class="heading-layout1 mb-0">
                            ...
                            <!-- Save & Cancel -->
                            <div class="">
                                <asp:Button ID="lbSave" runat="server" ValidationGroup="vgAddPayment" UseSubmitBehavior="false" OnClick="Save"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <div class="radio-list">
                                        <asp:RadioButtonList ID="rplTypes" runat="server" RepeatLayout="UnorderedList" AutoPostBack="true" OnSelectedIndexChanged="SelectForType">
                                            <asp:ListItem Value="T" Selected="True">Teacher</asp:ListItem>
                                            <asp:ListItem Value="V">Supervisor</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group" id="divTeacher" runat="server" visible="false">
                                    <label>Teacher</label>
                                    <asp:DropDownList ID="ddlTeacher" runat="server" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="SelectTeacher">
                                        <asp:ListItem Value="">Please Select Teacher</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group" id="divSupervisor" runat="server" visible="false">
                                    <label>Supervisor</label>
                                    <asp:DropDownList ID="ddlSupervisor" runat="server" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="SelectSupervisor">
                    ...
                    <div class="card-body modal-box">
                        ...
                        <div class="new-added-form">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Session</label>
                                    <asp:DropDownList ID="ddlSession" runat="server" CssClass="select2" AutoPostBack="true" OnSelectedIndexChanged="SelectSession">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>Amount</label>
                                    <asp:TextBox ID="txtAmount" Enabled="false" runat="server" CssClass="form-control" MaxLength="200"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <asp:LinkButton ID="lbSubmitSession" runat="server" ValidationGroup="vsSessions" OnClick="SubmitDetails"
                                    ...
                                    <asp:ListView ID="lvDetails" runat="server" ClientIDMode="AutoID">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:LinkButton ID="lbEdit" runat="server" CssClass="btn btn-info text-white" OnClick="EditDetails">
