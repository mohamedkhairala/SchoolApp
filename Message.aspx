        ...
        <div class="card-body">
            ...
            <div class="new-added-form">
                <asp:Panel runat="server" ID="pnlForm">
                    <asp:ValidationSummary ID="ValidationSummary" ClientIDMode="Static" DisplayMode="BulletList" ValidationGroup="vMessage" EnableClientScript="true" runat="server" CssClass="ValidationSummary" Visible="false" />

                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                            <label>Title *</label>
                            <asp:TextBox ID="txtMessageTitle" runat="server" CssClass="form-control" MaxLength="200"></asp:TextBox>
                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="reqFnAME" runat="server" ValidationGroup="vMessage"
                        ...
                        <asp:Panel runat="server" ID="pnlStudent" CssClass="d-contents">
                            <div class="col-xl-4 col-lg-4 col-4 form-group">
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="Select Group"
                                    ValidationGroup="vMessage" CssClass="valid-inp"
                                    ControlToValidate="ddlGroups" InitialValue="0" runat="server" />
                            </div>
                            <div class="col-xl-4 col-lg-4 col-4 form-group">
                        ...
                        <div class="col-12 form-group mg-t-8">
                            <asp:LinkButton ID="lbSave" runat="server" ValidationGroup="vMessage"
