                                        ...
                                        <asp:ListView ID="lvSessions" runat="server" ClientIDMode="AutoID">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox autocomplete="off" ID="txtTitle" runat="server" Text='<%# Eval("Title")%>' CssClass="form-control" Style="min-width: 200px;"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtDefaultPeriodHour" runat="server" Text='<%# PublicFunctions.GetDecimalValue(Eval("DefaultPeriodHour").ToString)%>' 
                                                            TextMode="Number" MaxLength="2" CssClass="form-control"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtRemarks" runat="server" Text='<%# Eval("Remarks")%>' TextMode="MultiLine"
                                                            CssClass="form-control" name="message" Rows="1" Style="min-width: 200px;"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                ...
                                                <asp:ListView ID="lvStudents" runat="server" ClientIDMode="AutoID">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtCoursePrice" runat="server" Text='<%# PublicFunctions.GetDecimalValue(Eval("CoursePrice").ToString)%>' 
                                                                    TextMode="Number" AutoPostBack="true" OnTextChanged="CalculateNetAmountInLV" CssClass="form-control"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtDiscountRate" runat="server" Text='<%# PublicFunctions.GetDecimalValue(Eval("DiscountRate").ToString)%>' 
                                                                    TextMode="Number" AutoPostBack="true" OnTextChanged="CalculateNetAmountInLV" CssClass="form-control"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtDiscountReason" runat="server" Text='<%# Eval("DiscountReason")%>' TextMode="MultiLine" CssClass="form-control" name="message" Rows="1" Style="min-width: 200px;"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
