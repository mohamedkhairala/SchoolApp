<%@ Page Title="Up Skills | All Attendance" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Attendance.aspx.vb" Inherits="Attendance" %>
            ...
            <div class="table-responsive">
                ...
                <asp:ListView ID="lvMaster" runat="server" ClientIDMode="AutoID">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <a href='<%# "Add_Attendance.aspx?Mode=View&ID=" & Eval("ID")%>' target="_blank"><%# Eval("Session")%></a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <asp:Panel ID="pnlEdit" runat="server">
                                            <asp:LinkButton ID="lbEdit" runat="server" CssClass="dropdown-item" target="_blank" href='<%# "Add_Attendance.aspx?Mode=Edit&ID=" & Eval("ID")%>'>
                                              <i class="fas fa-cogs text-dark-pastel-green"></i>Edit
                                            </asp:LinkButton>
                                        </asp:Panel>
...
<asp:Content ID="PageFooter" ContentPlaceHolderID="Footer" runat="Server">
    ...
    <script>
        $('#DataTables').DataTable({
            bLengthChange: false,
            language: {
                searchPlaceholder: "Search by Course, Group, Session, Teacher or Supervisor ...",
            },
            columnDefs: [
