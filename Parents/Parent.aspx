                        ...
                        <asp:Panel runat="server" ID="pnlForm">
                            <div class="row">
                                ...
                                <div class="col-xl-9 col-lg-6">
                                    <asp:ValidationSummary ID="vsParent" ClientIDMode="Static" DisplayMode="BulletList" ValidationGroup="vgParent" EnableClientScript="true" runat="server" CssClass="ValidationSummary" Visible="false" />

                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            <label>Code *</label>
                                            <asp:TextBox ID="txtCode" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
                                            <%--<asp:RequiredFieldValidator CssClass="valid-inp" ID="reqCode" runat="server" ValidationGroup="vgParent"
                                        ...
                                        <div class="col-xl-8 col-lg-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="reqFnAME" runat="server" ValidationGroup="vgParent"
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="RequiredFieldValidator2" runat="server" ValidationGroup="vgParent"
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="RequiredFieldValidator5" runat="server" ValidationGroup="vgParent"
                                        ...
                                        <div class="col-xl-8 col-lg-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="RequiredFieldValidator3" runat="server" ValidationGroup="vgParent"
                                                ControlToValidate="txtEmail" Display="Dynamic" Text="Required Email"></asp:RequiredFieldValidator>
                                            <asp:RegularExpressionValidator ID="revEmail" ValidationGroup="vgParent" CssClass="valid-inp" runat="server" ControlToValidate="txtEmail"
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator CssClass="valid-inp" ID="RequiredFieldValidator4" runat="server" ValidationGroup="vgParent"
                                        ...
                                        <div class="col-12 form-group mg-t-8">
                                            <asp:Button ID="lbSave" runat="server" ValidationGroup="vgParent" UseSubmitBehavior="false"
                                                CssClass="btn-fill-lg btn-gradient-yellow btn-hover-bluedark text-white"
                                                CommandArgument="Add" OnClick="Save" OnClientClick="SaveClick(this,'vgParent');" Text="Save" />
