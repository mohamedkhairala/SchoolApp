...
(function(h) {
    ...
    function qb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + '"/><i class="fas fa-search icon-search"></i>',
            j = d.sSearch,
            ...
            b = h("<div/>", {
                ...
                "class": b.sFilter
            }).append(h("<label class='position-relative w-100' />").append(j)),
            f = function() {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sSearch: "",
            sSearchPlaceholder: "Search by Code, Name or Group ...",
            sUrl: "",
